...
function nova_bridge_suite_get_targeted_rest_module_keys( string $route ): ?array {
    ...
    if ( nova_bridge_suite_rest_route_matches( $route, 'nova-bridge/v1/content-endpoints' )
        || nova_bridge_suite_rest_route_matches( $route, 'nova-bridge/v1/strategy' )
        || nova_bridge_suite_rest_route_matches( $route, 'nova-bridge/v1/mapping' )
    ) {
...
// Mapping discovery, configuration sync and delivery recovery also run during
// internal REST dispatch and cron. The module setting controls this runtime.
