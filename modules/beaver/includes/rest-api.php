 ...
 */
function nova_bb_permission_check( $request ) {
    ...
    // Coarse gate only — nova_bb_validate_write_request() re-checks the
    ...
    function () {
        ...
        register_rest_route(
            ...
            array(
                ...
                array(
                    'methods'             => 'GET',
                    'callback'            => 'nova_bb_list_pages',
                    'permission_callback' => 'nova_bb_permission_check',
                    'args'                => array(
                        'per_page'  => array(
                            'type'              => 'integer',
                            'default'           => 10,
